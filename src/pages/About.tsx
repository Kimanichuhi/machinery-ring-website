        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:px-8">
          <div className="flex flex-col items-start gap-6 sm:gap-8">
            <div className="flex-1">
              ...
              <p className="text-base sm:text-lg leading-7 sm:leading-8 text-muted-foreground text-justify">
              ...
              <p className="text-base sm:text-lg leading-7 sm:leading-8 text-muted-foreground text-justify mt-4">
          ...
          <div className="mx-auto mt-12 sm:mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            {team.map((member) => (
              <Card key={member.name} className="product-card">
                ...
                <CardContent>
                  <p className="text-sm sm:text-base text-muted-foreground">{member.bio}</p>
                </CardContent>
              </Card>
            ))}
          </div>
